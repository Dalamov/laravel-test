    ...
    <main class="container d-flex align-items-center mt-4 p-5 justify-content-around">
        <div class="mb-2 shadow p-3 mb-5 bg-white rounded p-4">
            ...
            <form action="/api/register" method="POST">
                <div>
                    <input name="email" class="form-control m-1" type="email" id="email" placeholder="Email" required></input>
                </div>
                <div>
                    <input name="name" class="form-control m-1" type="text" id="name" placeholder="Name" required></input>
                </div>
                <div>
                    <input name="password" class="form-control m-1" type="password" id="password" placeholder="password" required></input>
                </div>
                <div>
                    <input name="confirm_password" class="form-control m-1" type="password" id="password" placeholder="confirm password" required></input>
                </div>
